...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="http://localhost/web_files/official_web/admin/">Admin</a>
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      <li class="<?php echo isset($open) && $open =='subjects'? ' active':'' ?>">
        <a class="nav-link" href="<?php echo modules("subjects") ?>">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>Môn thi</span>
        </a>
      </li>
      <li class=" <?php echo isset($open) && $open =='students'? 'active':'' ?>">
        <a class="nav-link" href="<?php echo modules("students") ?>">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>Sinh viên </span>
        </a>
      </li>
      <li class="<?php echo isset($open) && $open =='exams'? ' active':'' ?> ">
